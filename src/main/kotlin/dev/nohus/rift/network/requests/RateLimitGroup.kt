...
sealed class RateLimitGroup(val name: String) {
    ...
    data object Activity : RateLimitGroup("activity")
    ...
    data object CharStructure : RateLimitGroup("char-structure")
    data object CharActivity : RateLimitGroup("char-activity")
    data object CorpWallet : RateLimitGroup("corp-wallet")
    data object CorpStructure : RateLimitGroup("corp-structure")
