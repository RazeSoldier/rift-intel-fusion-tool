...
object NetworkTracks {
    ...
    private fun getSoundtrackTracks(): List<Track> {
        return listOf(
            ...
            NetworkTrack("Surplus of Rare Artifacts", "5:58", "EVE Online - Surplus of Rare Artifacts.mp3"),
            NetworkTrack("The Green Nebula", "6:25", "EVE Online - The Green Nebula.mp3"),
            NetworkTrack("Primordial Star Clouds", "5:33", "EVE Online - Primordial Star Clouds.mp3"),
